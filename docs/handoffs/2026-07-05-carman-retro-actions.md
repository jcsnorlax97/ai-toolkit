...
- **Task 3 superseded**: see `docs/handoffs/2026-07-05-preset-powershell-consistency.md` — `apply-preset.sh` retired; preset verb added to `baseline.ps1` as `baseline apply-preset`, reusing the managed-block engine (no duplicates on re-apply).
